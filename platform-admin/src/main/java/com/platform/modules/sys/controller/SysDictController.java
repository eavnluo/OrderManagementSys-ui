 ...
 * 修改履历:
 *     日期                       修正者        主要内容
 *     2019-01-15 11:42:20        tp     初版做成
 *
 * Copyright (c) 2018-2019 tp软件
 */
...
public class SysDictController {
    ...
    public RestResponse queryByName(@RequestParam Map<String, Object> params){
        List<SysDictEntity> list = sysDictService.queryByName(params);
        return RestResponse.success().put("list",list);
    }
}
